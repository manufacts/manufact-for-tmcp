[![Deploy to mcp-use](https://cdn.mcp-use.com/deploy.svg)](https://mcp-use.com/deploy/start?repository-url=https%3A%2F%2Fgithub.com%2Fmanufacts%2Fmanufact-for-tmcp&branch=main&project-name=manufact-for-tmcp&port=3000&build-command=npm+run+build&start-command=npm+start&runtime=node&base-image=node%3A20)
...
Click the badge above, or open the [one-click deploy flow](https://mcp-use.com/deploy/start?repository-url=https%3A%2F%2Fgithub.com%2Fmanufacts%2Fmanufact-for-tmcp&branch=main&project-name=manufact-for-tmcp&port=3000&build-command=npm+run+build&start-command=npm+start&runtime=node&base-image=node%3A20). Sign in, connect GitHub, and Manufact clones this repo into your account and deploys it.
